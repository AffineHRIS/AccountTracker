...
CREATE TABLE `sow` (
  ...
  `SOW_Max_Offshore_Hours_Per_Day` varchar(45) DEFAULT NULL,
  `SOW_Currency` varchar(45) DEFAULT 'USD',
  `SOW_Onsite_Discount` varchar(45) DEFAULT NULL,
  `SOW_Offshore_Discount` varchar(45) DEFAULT NULL,
  `SOW_Additional` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`SOW_Id`),
...
INSERT INTO `sow` VALUES (1,'SOW1','1234',1,'test','2018-03-27 00:00:00','2018-03-31 00:00:00','10000','10','22','12','10','1000','8','20','monthly','10','120','Affine _ IT Proof submission forms FY 2017-18.xlsx','8.5','GBP','20','10','na');
...
-- Dump completed on 2018-04-04 13:28:39
