...
--
-- Host: localhost    Database: accountstracker
-- ------------------------------------------------------
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `msa` (
  `MSA_Id` bigint(20) NOT NULL,
  `MSA_Name` varchar(20) NOT NULL,
  `Account_Id` bigint(20) NOT NULL,
  `MSA_File` varchar(20) NOT NULL,
  `MSA_Start_Date` datetime DEFAULT NULL,
  `MSA_End_Date` datetime DEFAULT NULL,
  `MSA_Signing_Person` varchar(50) DEFAULT NULL,
  `MSA_Signing_Person_Email` varchar(50) NOT NULL,
  `MSA_Signing_Person_Number` int(11) DEFAULT NULL,
  `MSA_Payment_Mode` varchar(50) DEFAULT NULL,
  `MSA_Financial_Person_Contact` varchar(50) DEFAULT NULL,
...
CREATE TABLE `sow` (
  ...
  `SOW_Name` varchar(45) DEFAULT NULL,
  ...
  `SOW_File` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2018-03-21 11:42:12
